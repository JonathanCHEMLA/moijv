 ...
 */
class Version20180404081548 extends AbstractMigration
{
    ...
    //on te propose: soit d'effectuer les migrations(up) soit de revenir en arriere: (down).cela supprimera le lien entre la table product et la table tag
...
// on fait ensuite : php bin/console doctrine:migrations:migrate
// les migrations c'est vraiment utile pour travailler en equipe!!! et c'est aussi utile pour deployer son appli(signifie lorsqu on met notre appli en production)